...
public class ProductService {
    ...
    public ProductDto getProductById(Long id) {
        ProductEntity product = productRepo.findById(id).orElseThrow(() -> ProductNotFoundException.forId(id));
    ...
    public ProductDto updateProduct(long id, ProductRequestDto productRequestDto) {
        ProductEntity productEnity = productRepo.findById(id).orElseThrow(() -> ProductNotFoundException.forId(id));
    ...
    public ProductDto partialUpdateProduct(long id, ProductNullableRequestDto productRequestDto) {
        ProductEntity productEntity = productRepo.findById(id).orElseThrow(() -> ProductNotFoundException.forId(id));
